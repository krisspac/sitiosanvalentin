...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = 'OOOOh😱😱 no pense que le ibas a dar al Si!! Gracias Chiki TQM😊😊';
    document.getElementById('messageContainer').innerHTML += '<br>Donde te gustaria que nos veamos y a que hora....😉😁';
